...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; scroll-behavior: smooth; }
        ...
        /* RINGKASAN PRODUK - GELAP DI LIGHT MODE */
        .summary-item {
...
<div class="modal-overlay" id="successModal">
    <div class="modal-box">
        <div class="text-center">
            ...
            <p class="mt-2">Pesanan Anda telah kami terima dan akan segera diproses.</p>
            <p class="text-sm text-gray-400 mt-1" id="orderIdDisplay">ID Pesanan: #1</p>
            <button onclick="window.location.href='/'" class="mt-4 bg-[#f59e0b] text-white px-6 py-2 rounded-full font-bold hover:bg-[#d97706] transition">
        ...
        setTimeout(() => {
            ...
            fetch('save_order.php', {
                ...
                body: JSON.stringify({
                    ...
                    qty: Object.values(selectedProducts).reduce((a, b) => a + b, 0),
                    total: currentTotal,
            ...
            .then(data => {
                closePaymentModal();
                document.getElementById('orderIdDisplay').textContent = 'ID Pesanan: #' + data.order_id;
