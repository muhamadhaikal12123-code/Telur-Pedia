...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; }
        ...
        .user-avatar { width: 32px; height: 32px; border-radius: 50%; background: #f59e0b; color: white; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 14px; }
...
<div class="main-content">
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500">Welcome back, <?= $_SESSION['user']['name'] ?? 'Admin' ?>!</p>
        </div>
