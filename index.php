...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; scroll-behavior: smooth; }
        ...
        .hero .text-gray-600 { color: #334155 !important; }
        .dark .hero .text-gray-600 { color: #94a3b8 !important; }
        ...
        .price { font-size: 26px; font-weight: 800; color: #0f172a !important; }
        .dark .price { color: #fbbf24 !important; }
        ...
        .footer .text-gray-500, .footer .text-gray-400, .footer .text-gray-600 { color: #475569 !important; }
        .dark .footer .text-gray-500, .dark .footer .text-gray-400, .dark .footer .text-gray-600 { color: #94a3b8 !important; }
        ...
        /* HERO PRICE - BACKGROUND PUTIH, TULISAN EMAS */
        .hero-price-box {
            background: #ffffff;
        ...
        .dark .contact-info { background: #1e293b; border-color: #334155; }
        .contact-info .text { 
            color: #0f172a !important; 
            font-size: 14px; 
            font-weight: 500; 
        }
        .dark .contact-info .text { color: #e2e8f0 !important; }
        .contact-info .icon-gold { color: #f59e0b; }
...
<section id="products" class="section-gray py-16">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="text-center mt-12">
            ...
            <p class="section-subtitle mt-3">Kamu akan diarahkan ke halaman checkout</p>
        </div>
    </div>
</section>
...
<section id="faq" class="section-white py-16 max-w-4xl mx-auto px-6">
    ...
    <div class="space-y-4">
        <div class="faq-item scroll-animate">
            ...
            <div class="a mt-2 hidden">Klik tombol "Pesan Sekarang" di bawah produk, isi data di halaman checkout, lalu bayar.</div>
        </div>
        <div class="faq-item scroll-animate">
            <button class="faq-toggle w-full text-left flex justify-between items-center">
        ...
        <div class="faq-item scroll-animate">
            ...
            <div class="a mt-2 hidden">Setelah checkout selesai, Anda akan mendapatkan nomor lacak di halaman sukses.</div>
        </div>
        <div class="faq-item scroll-animate">
            <button class="faq-toggle w-full text-left flex justify-between items-center">
    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="mt-6 text-center scroll-animate">
            <div class="contact-info">
                <i class="fas fa-clock icon-gold text-xl"></i>
                <span class="text">Senin - Minggu: 08.00 - 20.00</span>
                <i class="fas fa-phone icon-gold text-xl ml-2"></i>
